<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="location.aspx.cs" Inherits="Travel.location" %>
<!DOCTYPE html>
<html>
<head>
	<title>Location | MyBook</title>
	...
	<div class="landing">
		<div class="leftNav">
            <asp:Image ID="Image1" runat="server" style=" width:260px;"/>
	          ...
	          <li><a href="home.aspx">News</a></li>
	           	...
	           	<li><a href="location.aspx" class="active">Location</a></li>
		...
		<div class="newfeed-profile">
			...
			<div class="profile-details">
				<h3>Past Location</h3>
				<span class="info-head">Leena Masqurade</span><p class="info-body"> at Kathmandu in Dec 10</p>
